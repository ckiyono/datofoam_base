...
class PYDAFOAM(object):
    ...
    def calcPsi(self):
        ...
        Output:
        -------
        ASCII files containing the Psi vectors

        self.adjVectors: the dict contains all the Psi vectors
        ...
        for objFuncName in objFuncDict:
            self.writePetscVecMat("psi_%s" % objFuncName, self.adjVectors[objFuncName], "ASCII")
        
        return self.adjointFail
